...
class HomeWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        # display error message on connection error
        if self.get_collects(False) is None:
            QtWidgets.QMessageBox.warning(
                self,
                "Erreur d'accès aux données anam-receiver",
